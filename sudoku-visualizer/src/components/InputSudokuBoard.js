    ...
    return(
      <div className="grid grid-rows-3 grid-flow-col">
        <form id="inputForm" onSubmit={props.handleString} className="w-11/12 justify-self-center">
          <input className="backdrop-blur-lg w-full border-2 border-solid text-2xl text-center rounded-md focus:outline-0 border-slate-200 bg-slate-100 h-12" type="text" placeholder="Enter sudoku string" readOnly={false} name="sudokustring"/>
        </form>
